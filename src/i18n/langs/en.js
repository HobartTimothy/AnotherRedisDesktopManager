const en = {
  message: {
    ...
    redis_username_tip: '(Optional) Redis ACL Username',
    ...
    tree_view: 'Tree View',
    flat_view: 'Flat View',
    load_key_count: 'Keys Per Load',
    db_filter_mode: 'DB Filter Mode',
    show_all: 'Show All',
    show_specified: 'Show Only',
    hide_specified: 'Hide Only',
    db_filter_list: 'DB List',
    db_filter_placeholder: 'Enter DB numbers, separated by comma, e.g: 0,1,2',
    mark_color: 'Mark Color',
    readonly_mode: 'Readonly Mode',
    add: 'Add',
    enable_ssl: 'Enable SSL',
    ssl_cert_placeholder: 'PEM Public Key (Cert)',
    ssl_key_placeholder: 'PEM Private Key (Key)',
    ssl_ca_placeholder: 'PEM Certificate Authority (CA)',
    reject_unauthorized: 'Allow Insecure',
    sni_servername: 'Server Name (SNI)',
    enable_ssh: 'Enable SSH Tunnel',
    ssh_host: 'SSH Host',
    ...
    enable_sentinel: 'Enable Sentinel',
    enable_cluster: 'Enable Cluster',
    enable_proxy: 'Enable Proxy',
    proxy_type: 'Proxy Type',
    proxy_address: 'Proxy Address',
    test_connection: 'Test Connection',
    parse_clipboard_url: 'Parse URL from Clipboard',
    update: 'Update',
    connect_success: 'Connection successful',
    connect_fail: 'Connection failed',
    client_error: 'Client error',
    client_error_connection_refused: 'Connection refused, please check if the configuration is correct',
    client_error_timeout: 'Connection timeout',
    client_error_host_not_found: 'Host not found',
    client_error_connection_reset: 'Connection reset',
    client_error_auth_failed: 'Authentication failed, please check username and password',
    ...
    icon_size_tip: 'Max 180x180 pixels or 100KB',
    icon_size_exceed: 'Image size cannot exceed 100KB',
    remove: 'Remove',
    confirm_delete_group: 'Confirm to delete this group? Connections will be moved to ungrouped.',
    ...
    sync_mode_s3: 'S3 Sync',
    s3_config: 'S3 Config',
    s3_endpoint: 'Endpoint',
    s3_region: 'Region',
    s3_bucket: 'Bucket',
    s3_prefix: 'Prefix Path',
    s3_parallelism: 'Parallelism',
    s3_test_connection: 'Test',
    s3_upload: 'Upload',
    s3_download: 'Download',
    s3_connection_success: 'S3 connection successful',
    s3_connection_failed: 'S3 connection failed',
    s3_upload_confirm: 'This will overwrite remote config. Continue?',
    s3_upload_success: 'Upload successful',
    s3_upload_failed: 'Upload failed',
    s3_download_confirm: 'This will overwrite local config. Continue?',
    s3_download_success: 'Download successful',
    s3_download_failed: 'Download failed',
    s3_endpoint_required: 'Endpoint is required',
    ...
    font_size: 'Font Size',
    font_placeholder: 'Select or enter font name',
    key_icon_style: 'Key Icon Style',
    compact_style: 'Compact',
    normal_style: 'Normal',
    show_line_numbers: 'Show Line Numbers',
    enable_code_folding: 'Enable Code Folding',
    allow_drag_drop: 'Allow Drag Drop Text',
    support_links: 'Support Link Navigation',
    ...
    reset_confirm: 'Confirm reset all settings to default?',
    save_success: 'Save successful',
    // Custom Decoder
    add_decoder: 'Add Custom Decoder',
    add_decoder_title: 'Add Decoder/Encoder',
    ...
    decoder_path_tip: 'External decoder program path',
    run_args: 'Run Args',
    run_args_tip: 'Arguments passed to decoder program',
    auto_decode: 'Auto Decode',
    please_input: 'Please input',
    decoder_name_required: 'Decoder name is required',
    decoder_path_required: 'Decoder path is required',
    confirm_delete: 'Confirm delete?',
    decoder_help_content: 'Custom decoder allows you to use external programs to decode/encode values in Redis.<br><br>The decoder program will receive raw value from stdin and output decoded result to stdout.',
    // Decoder extras
    more_actions: 'More Actions',
    enable_all: 'Enable All',
    disable_all: 'Disable All',
    test_decoder: 'Test Decoder',
    edit_decoder_title: 'Edit Decoder/Encoder',
    arg_placeholder: 'Enter argument',
    test_value: 'Test Value',
    test_value_placeholder: 'Enter test value to decode...',
    run_test: 'Run Test',
    test_output: 'Output',
