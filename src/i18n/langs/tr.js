const tr = {
  message: {
    ...
    general_config: 'Genel',
    editor: 'Editör',
    cli: 'CLI',
    custom_decoder: 'Özel Kod Çözücü',
    font_size: 'Font Boyutu',
    font_placeholder: 'Font adını seçin veya girin',
    key_icon_style: 'Anahtar İkon Stili',
    compact_style: 'Kompakt',
    normal_style: 'Normal',
    show_line_numbers: 'Satır Numaralarını Göster',
    enable_code_folding: 'Kod Katlamayı Etkinleştir',
    allow_drag_drop: 'Metin Sürükle Bırak',
    support_links: 'Bağlantı Gezinmesini Destekle',
    ...
    reset_confirm: 'Tüm ayarları varsayılana sıfırlamayı onaylıyor musunuz?',
    save_success: 'Başarıyla kaydedildi',
    // Custom Decoder
    add_decoder: 'Özel Kod Çözücü Ekle',
    add_decoder_title: 'Kod Çözücü/Kodlayıcı Ekle',
    decoder_name: 'Kod Çözücü Adı',
    command_preview: 'Komut Önizleme',
    status: 'Durum',
    operation: 'İşlem',
    no_data: 'Veri Yok',
    help: 'Yardım',
    decoder: 'Kod Çözücü',
    encoder: 'Kodlayıcı',
    decoder_path: 'Kod Çözücü Yolu',
    encoder_path: 'Kodlayıcı Yolu',
    decoder_path_tip: 'Harici kod çözücü program yolu',
    run_args: 'Çalıştırma Argümanları',
    run_args_tip: 'Kod çözücü programına iletilen argümanlar',
    auto_decode: 'Otomatik Kod Çöz',
    please_input: 'Lütfen girin',
    decoder_name_required: 'Kod çözücü adı gereklidir',
    decoder_path_required: 'Kod çözücü yolu gereklidir',
    confirm_delete: 'Silmeyi onaylıyor musunuz?',
    decoder_help_content: 'Özel kod çözücü, Redis\'teki değerleri kod çözmek/kodlamak için harici programlar kullanmanıza olanak tanır.<br><br>Kod çözücü programı stdin\'den ham değeri alır ve kod çözülmüş sonucu stdout\'a çıktı verir.',
    // Decoder extras
    more_actions: 'Daha Fazla İşlem',
    enable_all: 'Tümünü Etkinleştir',
    disable_all: 'Tümünü Devre Dışı Bırak',
    test_decoder: 'Kod Çözücüyü Test Et',
    edit_decoder_title: 'Kod Çözücü/Kodlayıcıyı Düzenle',
    arg_placeholder: 'Argüman girin',
    test_value: 'Test Değeri',
    test_value_placeholder: 'Kod çözmek için test değeri girin...',
    run_test: 'Testi Çalıştır',
    test_output: 'Çıktı',
    test_success: 'Test başarılı',
    error: 'Hata',
    import_decoder: 'Kod Çözücüleri İçe Aktar',
    import_failed: 'İçe aktarma başarısız',
    // Data Sync
    data_sync: 'Veri Senkronizasyonu',
    manual_sync: 'Manuel Senkronizasyon',
    manual_sync_desc: 'Tercihler, bağlantılar, gruplar ve kod çözücüler dahil tüm yapılandırmaları manuel olarak içe veya dışa aktarın',
    s3_sync: 'S3 Bulut Senkronizasyonu',
    s3_sync_desc: 'S3 uyumlu depolama (AWS S3/Aliyun OSS/MinIO vb.) kullanarak tüm yapılandırmaları senkronize edin',
