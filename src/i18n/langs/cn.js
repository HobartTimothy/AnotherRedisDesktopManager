const cn = {
  message: {
    ...
    connect_fail: '连接失败',
    client_error: '客户端错误',
    client_error_connection_refused: '连接被拒绝，请检查配置是否正确',
    client_error_timeout: '连接超时',
    client_error_host_not_found: '主机未找到',
    client_error_connection_reset: '连接被重置',
    client_error_auth_failed: '认证失败，请检查用户名和密码',
