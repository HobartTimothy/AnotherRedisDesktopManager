const ko = {
  message: {
    ...
    client_error_connection_refused: '연결이 거부되었습니다. 설정이 올바른지 확인하세요',
    client_error_timeout: '연결 시간 초과',
    client_error_host_not_found: '호스트를 찾을 수 없습니다',
    client_error_connection_reset: '연결이 재설정되었습니다',
    client_error_auth_failed: '인증 실패, 사용자 이름과 비밀번호를 확인하세요',
