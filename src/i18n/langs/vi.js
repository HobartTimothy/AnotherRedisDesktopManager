const vi = {
  message: {
    ...
    client_error_connection_refused: 'Kết nối bị từ chối, vui lòng kiểm tra xem cấu hình có đúng không',
    client_error_timeout: 'Hết thời gian chờ kết nối',
    client_error_host_not_found: 'Không tìm thấy máy chủ',
    client_error_connection_reset: 'Kết nối bị đặt lại',
    client_error_auth_failed: 'Xác thực thất bại, vui lòng kiểm tra tên người dùng và mật khẩu',
